<script>
    ...
    function confirmLogin() {
        if (passwordValidity === "valid" && usernameValidity === "valid") {
            logins = [...usernames,logins, enteredUsername, enteredPassword];
        }
    }
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form">
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="login100-form-btn">
                                <!--<button on:click={() => changePage('login')}>LOGIN</button>-->
                                <button
                                    on:click={confirmUsername}>Create Usuario</button                                       
                                >
                            </button>
                        </div>                       
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="login100-form-btn">
                                <!--<button on:click={() => changePage('login')}>LOGIN</button>-->
                                <button
                                    on:click={confirmPassword}>Create Password</button                                       
                                >
                            </button>
                        </div>
                    ...
                    <div class="flex-col-c p-t-155">
                        ...
                        <a href="#" class="txt2">
                            <button
                                on:click={() => changePage("registerUsuario")}
                                >Sign Up</button
                            >
                        </a>
